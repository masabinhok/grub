...
if (fs.existsSync(PROFILE_README)) {
  ...
  // The streak card is the one image that is NOT on raw.githubusercontent and so is
  ...
  // the previous owner's counter and shows you their card.
  //
  ...
  if (worker) {
    ...
    console.log('    and swap the host, or point the card back at your own assets/bare/streak.svg');
