...
<!--
  The view counter. Unlike every other image on this page it is NOT generated by
  the daily workflow — it is served live by the Cloudflare Worker in counter/,
  which has to be deployed separately (`cd counter && npx wrangler deploy`).

  It counts camo fetches of the badge — i.e. how many times this README was
  rendered in a browser — not unique visitors, which GitHub makes impossible to
  measure. counter/README.md explains exactly what the number is and is not.
-->
<p align="center">
  <img src="https://grub-views.sifarish-less.workers.dev/badge.svg" alt="Profile README renders" height="40">
</p>
